...
export const usernameIsValid = (username: string): boolean => {
    return isValidLength(username, usernameConstants.MIN_USERNAME_LENGTH, usernameConstants.MAX_USERNAME_LENGTH)
        && isValidCharacters(username, usernameConstants.ALLOWED_CHARACTERS)
}

export const passwordIsValid = (password: string): boolean => {
    return isValidLength(password, passwordConstants.MIN_PASSWORD_LENGTH, passwordConstants.MAX_PASSWORD_LENGTH)
